        ...
        <div className="grid items-center gap-8 sm:grid-cols-2">
          <div>
            ...
            <h1 className="mt-4 text-4xl font-bold leading-tight sm:text-5xl">
              Jusqu’à <span className="underline decoration-white/60 decoration-4 underline-offset-4">{CONFIG.filleulBonus}€</span> offerts à l’ouverture*
            </h1>
            <p className="mt-4 text-white/90">
              Ouvrez votre compte {CONFIG.bankName}, indiquez le code de parrainage et complétez les étapes. Le parrain
              reçoit {CONFIG.parrainBonus}€ par filleul validé.
            </p>
            <div className="mt-6 flex flex-wrap items-center gap-3">
              <PrimaryButton href="#offres">Voir les offres</PrimaryButton>
              <button
                onClick={copy}
              ...
              >
                ...
                <span className="opacity-70 group-hover:opacity-100">{copied ? "(copié)" : "Copier le code"}</span>
              </button>
            </div>
            <p className="mt-3 text-sm text-white/70">*Montant indicatif, offre sujette à conditions et évolution.</p>
          </div>
